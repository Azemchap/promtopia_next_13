...
export default function Footer() {
    ...
    return (
        <footer className=" bg-indigo-800 text-gray-50 w-full" aria-labelledby="footer-heading">
            <h2 id="footer-heading" className="sr-only">
                Footer
            </h2>
            <div className=" mx-auto py-12 px-4 sm:px-6 lg:py-16">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="grid grid-cols-2 gap-8 xl:col-span-2">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 className="text-sm font-semibold text-gray-50 tracking-wider uppercase">Programs</h3>
                            ...
                            <div className="mt-12 md:mt-0">
                                <h3 className="text-sm font-semibold text-gray-50 tracking-wider uppercase">Support</h3>
                                <ul role="list" className="mt-4 space-y-4">
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 className="text-sm font-semibold text-gray-50 tracking-wider uppercase">About us</h3>
                                <ul role="list" className="mt-4 space-y-4">
                    ...
                    <div className="mt-8 xl:mt-0">
                        ...
                        <p className="mt-4 text-base text-indigo-300">
                            The latest news, articles, and updates, sent to your inbox.
                        </p>
                ...
                <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
                    <div className="flex space-x-6 md:order-2">
                        {navigation.social.map((item) => (
                            <Link key={item.name} href={item.href} className="text-gray-200 hover:text-gray-500">
